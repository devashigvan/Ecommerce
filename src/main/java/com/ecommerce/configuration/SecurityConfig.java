...
import com.ecommerce.service.ConstomUserDetailService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	private ConstomUserDetailService constomUserDetailService;

	@Override
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/", "/shop/**", "/register").permitAll().antMatchers("/admin/**")
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		auth.userDetailsService(constomUserDetailService);
	}
